...
- `gateway.activateSessionSkill`：在当前会话激活指定技能
- `gateway.deactivateSessionSkill`：在当前会话停用指定技能
- `gateway.listSessionSkills`：查询当前会话已激活技能
- `gateway.listAvailableSkills`：查询当前可用技能（含是否激活）
